...
This project provides a configurable webchat environment used for testing and demonstrating **Yourtown support services** such as **Kids Helpline (KHL)** and **Parentline**.
...
- Custom suggested action styling
...
to apply custom styles and branding at runtime.
